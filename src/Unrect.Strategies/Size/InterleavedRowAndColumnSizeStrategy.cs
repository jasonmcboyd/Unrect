...
namespace Unrect.Strategies
{
  ...
  internal sealed class InterleavedRowAndColumnSizeStrategy : IIncrementalSizeStrategy
  {
    ...
    private sealed class Scan : IAreaScan
    {
      ...
      public Scan(ICellValues space, IRowScan rows, IColumnAccumulator columns)
      {
        Rows = rows;
      ...
      /// </summary>
      private int DecideWidth(ICellValues space, IRowScan rows, IColumnAccumulator columns)
      {
