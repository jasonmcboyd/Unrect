...
{
  /// <summary>How a projection's origin is found within the space it is handed — a fixed skip, a seek past blanks, a landmark.</summary>
  public interface IOffsetStrategy
  {
    ...
    Offset GetOffset(Plane<ISpace> availableSpace);
  }
}
