...
{
  /// <summary>How a projection's extent is discovered from the space it is handed, rather than declared as a fixed number.</summary>
  public interface ISizeStrategy
  {
    ...
    Size GetSize(ICellValues availableSpace);
  }
}
