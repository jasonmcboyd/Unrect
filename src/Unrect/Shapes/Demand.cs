...
{
  /// <summary>
  /// EXPERIMENT (typed-spaces): the witness a capability's package publishes so an ascription can be
  /// written without type arguments — <c>rows.Demanding(Formulas)</c> instead of
