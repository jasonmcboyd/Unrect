...
namespace Unrect.Projections
{
  ...
  /// deliberately separate — a caller should not be able to end a horizontal projection at a row —
  /// but a bounded projection has exactly one of them, and holding "an orientation plus one of two
  /// nullable landmarks" would let a state exist that the type says nothing about.
  /// </summary>
