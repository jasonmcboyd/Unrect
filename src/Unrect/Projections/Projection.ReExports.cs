...
{
  /// <summary>
  /// The strategy layer's vocabulary, re-exported so <c>using static
  /// Unrect.Projections.Projection;</c> really is the only import a declaration needs. Each of
  /// these forwards and adds nothing; where a name reads better in a declaration than it does in
  /// the strategy layer, it is renamed here.
  /// </summary>
  public static partial class Projection
  {
    ...
    // projection declaration should need one import. Everything here returns the IAreaStrategy the
