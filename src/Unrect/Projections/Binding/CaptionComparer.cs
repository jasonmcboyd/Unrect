...
namespace Unrect.Projections
{
  ...
  /// </para>
  /// <para>
  /// Nothing but whitespace and case is ignored: punctuation, parentheses and <c>%</c> all count,
  /// so <c>"Net (USD)"</c> needs an explicit caption rather than binding to <c>NetUsd</c>. Every
