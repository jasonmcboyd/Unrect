...
{
  /// <summary>
  /// The single definition of what a kind failure and a conversion failure say. The typed leaves
  /// and the table binder both read cells through here, so a <c>Decimal()</c> leaf and a
  ...
  /// number that is really there. Neither carries advice: a per-cell message can appear thousands
  /// of times in one sheet, and advice repeated that often is noise.
  /// </para>
  /// </summary>
