namespace Unrect.Projections
{
  ...
  public static partial class Projection
  {
    ...
    /// </para>
    /// </summary>
    public static IProjection<T> VerticalFlow<T>(Layout<T> build)
      => new FlowProjection<T>(Orientation.Vertical, NotNull(build, nameof(build)), Placement.Default);
    ...
    /// </summary>
    public static IProjection<T> HorizontalFlow<T>(Layout<T> build)
      => new FlowProjection<T>(Orientation.Horizontal, NotNull(build, nameof(build)), Placement.Default);
    ...
    /// </para>
    /// </summary>
    public static IProjection<T> Overlay<T>(Layout<T> build)
      => new OverlayProjection<T>(NotNull(build, nameof(build)), Placement.Default);
  }
}
