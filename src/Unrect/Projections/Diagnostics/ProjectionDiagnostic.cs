...
namespace Unrect.Projections
{
  ...
  /// subject, path, and location a <see cref="ProjectionException"/> would, so a warning is as easy
  /// to act on as an error — for an absorbed failure, they describe the projection that actually
  /// failed rather than the boundary that caught it.
  /// </summary>
  public sealed class ProjectionDiagnostic
  {
    internal ProjectionDiagnostic(
    ...
    /// <summary>The problem, phrased as in a <see cref="ProjectionException"/>.</summary>
    public string Message { get; }

    /// <summary>The quoted name or description of the projection the diagnostic is about.</summary>
